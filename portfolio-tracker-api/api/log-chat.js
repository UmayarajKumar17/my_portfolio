// Serverless function for logging chat messages to Firebase
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const { sessionId, message, sender, timestamp, userAgent, referrer } = body;
    ...
    return {
      statusCode: 500,
      headers,
      body: JSON.stringify({ error: 'Failed to log message' })
    };
  }
}; 